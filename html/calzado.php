    ...
    <script>
          ...
          //  lightSphere4.position = new BABYLON.Vector3(0, -90, 25);
           ...
           var camera = new BABYLON.FreeCamera("FreeCamera", new BABYLON.Vector3(0, -104, -20), scene);
            ...
            ground.material.diffuseTexture = new BABYLON.Texture("textures/horus-almond.jpg", scene);
            ground.material.diffuseColor = new BABYLON.Color3(0.67,0.75,0.77);
            ground.material.diffuseTexture.uScale = 80;
            ground.material.diffuseTexture.vScale = 80;
            ground.material.backFaceCulling = false;
            ground.material = new BABYLON.StandardMaterial("Mat", scene);
            ground.material.specularTexture = new BABYLON.Texture("textures/horus-almond.jpg", scene);
            ground.material.specularTexture.uScale = 80;
            ground.material.specularTexture.vScale = 80;
            ground.material.emissiveTexture = new BABYLON.Texture("textures/horus-almond.jpg", scene); 
            ground.material.emissiveTexture.uScale = 80;
            ground.material.emissiveTexture.vScale = 80;
